...
// 시각/명중률/인지력/민첩성/독내성/인식방해/집착)은 전 종족 0에서 시작한다
// (민첩성은 engine.ts의 attackSpeed()가 소비하지만, 0이면 기본 행동력
// BASE_ACTIONS_PER_ROUND만 나오므로 "0=아직 특별할 것 없음"이라는 의미는
// 그대로 유지된다 — designnotes.md 3-10번). 후각만 예외 — 수인의 시그니처
// 스탯으로 처음 값을 부여한다.
//
